                    ...
                    <div className="flex flex-wrap mb-24 -mx-4">
                        <div className="w-full px-4 mb-8 md:w-1/2 md:mb-0">
                            <div className="">
                                <div className="">
                                    <img
                                        className=" w-60 h-50 md:h-90 md:w-90 rounded-lg"
                        ...
                        <div className="w-full px-4 md:w-1/2">
                            <div className="lg:pl-20">
                                <div className="mb-6 ">
                                    ...
                                    <p className="inline-block text-2xl font-semibold text-black dark:text-gray-900 ">
                                        <span>Rs.7,000.00</span>
                                    </p>
                                </div>
                                <div className="mb-6">
                                    <h2 className="mb-2 text-lg font-bold text-gray-700 dark:text-gray-900">
                                        Description :
                                    </h2>
                                ...
                                <div className="flex flex-wrap items-center mb-6">
                                    ...
                                    <button
                                        className="w-full px-4 py-3 text-center text-violet-600 font-bold text-xl bg-violet-300 border-2 border-violet-600  hover:bg-violet-600 hover:text-gray-100 rounded-xl"
                                    >
                                        Add to cart
                                    </button>
                                </div>
